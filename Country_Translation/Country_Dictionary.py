...
def write_dictionary_file(country_dictionary, name_file):
    """
...
def main():
    ...
    #
    # print(country_link_creator(country_dictionary, "Greece"))
    debug_country_dictionary_creator("country_names_urls.txt", debug_dictionary)
    print(debug_dictionary)
