<?php 
			$formFile = fopen('Resources/formHandling.txt', 'r+');
			if (!empty($_POST)){

				$formFile = fopen('Resources/formHandling.txt', 'w');
				fwrite($formFile, $_POST['country']."\n".$_POST['startingDate']."\n".$_POST['endingDate']);
				define('TITLE', 'SIR for '.$_POST['country']);
				fclose($formFile);
			}else{
				fwrite($formFile,"World\n\n");
				define('TITLE', 'SIR for World');
			}
		 	...
		 	<div class="content">
		 		<div class="form">
		 			...
		 			<select name="country">
		 				...
		 				<option value="WithoutChina">World with out China</option>
		 		...
		 		<div>
		 			<?php
		 				...
		 				$formCountry=fgets($formFile);
		 				$formStartingDate=fgets($formFile);
		 				$formEndingDate=fgets($formFile);	
		 				if($formEndingDate=='' || $formStartingDate==''){
		 					?> <div class="visualization">
		 						<h3><?php echo $formCountry ?></h3>	 						
		 				...
		 				}else{?> <div class="visualization">
		 						<h3><?php echo $formCountry ?></h3>	 
		 						<p><?php if (!empty($_POST)){echo 'SIR model for the period '.$formStartingDate.'to '.$formEndingDate ;} ?></p><br>						
		 						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
		 						tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
		 						quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
		 						consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse
