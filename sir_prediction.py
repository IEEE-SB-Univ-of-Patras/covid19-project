...
def sir_method(data, b=transmission_rate, k=recovery_rate, offset=0, run=90):
    ...
    print("{} ---".format(data["Total list"]))
    print("{} ---".format(data["Deaths list"]))
    print("{} ---".format(data["R list"]))
    print("{} ---".format(data["I list"]))
    print("{} ---".format(data["S list"]))
    print("{} ---".format(data["New cases list"]))
    print("{} ---".format(data["Date list"]))
    print("{} ---".format(data["Death rate"]))
    return data
...
if __name__ == '__main__':
    Data = init_data(scenario=sys.argv[1])
    Data = sir_method(Data, offset=0, run=int(sys.argv[2]))
